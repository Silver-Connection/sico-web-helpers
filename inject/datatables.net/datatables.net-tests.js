...
var ajaxDataFunc = function (data, settings) { return data; };
ajaxDataFunc = function (data) { return ""; };
//#endregion "Ajax"
//#region "Settings"
var config = {
    // columns
...
var data_3 = dt
    ...
    .unique()
    .each(function (d) {
    var tag = "<option value=\"" + d + "\">" + d + "</option>";
    select.append($(tag));
});
...
var cells_invalidate_1 = cells.invalidate();
var cells_invalidate_2 = cells.invalidate("data");
...
$('#example').on('click', 'tbody td', function () {
    var idx = dt.cell(_this).index().row;
...
$('#example tbody').on('click', 'td', function () {
    alert(dt.cell(_this).cache('order'));
});
var cell_data_get = cell.data();
$('#example tbody').on('click', 'td', function () {
    alert(dt.cell(_this).data());
});
var cell_data_set = cell.data("string");
cell_data_set = cell.data(1);
$('#example tbody').on('click', 'td', function () {
    var cell = dt.cell(_this);
    cell.data(cell.data() + 1).draw();
});
var cell_index = cell.index();
$('#example tbody').on('click', 'td', function () {
    alert('Clicked on cell in visible column: ' + dt.cell(_this).index().columnVisible);
});
$('#example tbody').on('click', 'td', function () {
    var rowIdx = dt
        .cell(_this)
...
var cell_invalidate_1 = cell.invalidate();
var cell_invalidate_2 = cell.invalidate("data");
$('#example tbody').on('click', 'td', function () {
    _this.innerHTML = (parseInt(_this.innerHTML, 10) + 1).toString();
    dt.cell(_this).invalidate().draw();
});
...
$('#example').on('click', 'tbody td', function () {
    var data = dt.cell(_this).render('display');
    console.log(data);
});
$('#example').on('click', 'tbody td', function () {
    var data = dt.cell(_this).render('sort');
    console.log(data);
});
...
$('#example').on('click', 'tbody td', function () {
    var idx = dt.cell(_this).index().column;
...
dt.rows().eq(0).each(function (rowIdx) {
    var tag = "<tr><td>" + rowIdx + ".1</td><td>" + rowIdx + ".2</td><td>" + rowIdx + ".3</td><td>" + rowIdx + ".4</td></tr>";
    dt
        .row(rowIdx)
        .child($(tag))
        .show();
...
var static_3 = $("selector").DataTable();
var static_4 = $("selector").dataTable();
var static_5 = $("selector").dataTable().api();
var static_6 = new $.fn.dataTable.Api("selector");
var version = $.fn.dataTable.versionCheck("1.10.0");
var isDataTable = $.fn.dataTable.isDataTable("selector");
...
var defaults_1 = $.fn.dataTable.defaults;
